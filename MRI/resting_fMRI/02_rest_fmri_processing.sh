...
## Section 1: Run trained-FIX.
    ...
    for sub in "${subjects[@]}"; do
            cd /vols/Data/als/Alicia/data/*$sub*
            fsl_sub /home/fs0/steve/NETWORKS/fix/fix /vols/Data/als/Alicia/data/*$sub*/rest.ica /home/fs0/hpc655/scratch/ALS_HC_3T_106.RData 20 -m  # run FIX (batch on fsl_sub)
    done 

## Section 1: Registration to standard space.

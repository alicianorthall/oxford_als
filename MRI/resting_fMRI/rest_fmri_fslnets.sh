...
# PYTHONPATH=/vols/Data/als/Alicia/data/fslnets fslipython # import the updated fslnets package (installed locally)
...
nets.classify(Pnetmats, (6, 6), RandomForestClassifier())
